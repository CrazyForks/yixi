// The 今日 face rendered in English, end to end — the half of the i18n guard
// that test/i18n.test.ts cannot express.
//
...
// renders its Chinese verbatim. So this file renders the four real handlers
// with `Accept-Language: en` and asserts on the HTML that comes back:
// `<html lang="en">`, no Chinese punctuation left in <main>, and the
// particular sentences the design names.
//
