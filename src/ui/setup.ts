...
<p>第一步④的条件写的是「<b>等于 <code>block</code></b>」。这不是随手写的，<b>永远不要改成「不等于 <code>pass</code>」</b>。</p>

<p>差别在服务出问题的时候。<code>/gate</code> 有一堆理由给不出正常答复：token 被换了、Worker 挂了、
网络超时、返回了空。</p>

<ul>
<li><b>写「等于 block 才打开」</b>：上面每种异常都不等于 <code>block</code>，「如果」不成立，
快捷指令什么都不做直接结束，<b>你的 App 正常打开</b>。最坏结果是「今天没拦住你」。</li>
<li><b>写「不等于 pass 就打开」</b>：服务一挂，每次开 App 都跳去一个打不开的网页。
